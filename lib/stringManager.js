...
module.exports = class StringManager {
    ...
    /**
     * Verifie si une chaîne de caractères B est présente dans la chaîne de caractères A.
    ...
    /**
     * Verifie si une chaîne de caractères présente dans un tableau se trouve dans la chaîne de caractères A.
    ...
    /**
     * Méthode permettant de changer la chaîne de caractères à manipuler.
     * @param {string} str La nouvelle chaîne de caractères.
     */
    set string(str) {
        if (typeof str !== 'string') { throw new Error('StringManager : "string" attendue, reçu "' + typeof str + '"'); }
        return this.str = str;
    ...
    /**
     * Méthode permettant de récupérer la chaîne de caractères à manipuler.
     * @returns {string} retourne la chaîne de caractères.
     */
    toString() {
        return this.str;
    }
